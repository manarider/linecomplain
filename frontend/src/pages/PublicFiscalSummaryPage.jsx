...
const S = {
  ...
  lineBtnSmall: { fontSize: 12, padding: '6px 14px', gap: 6 },
  header: {
    minHeight: 0,
    display: 'flex',
    alignItems: 'center',
